      ...
      <div className="fade-up flex flex-col gap-3">
        ...
        {tab === "verify" && (
          <>
            ...
            {/* Tutorial card */}
            <section aria-labelledby="tutorial-title" className="card-soft overflow-hidden rounded-2xl">
              <div className="px-4 pb-1 pt-3">
                <h2 id="tutorial-title" className="text-[14px] font-semibold text-[var(--brand)]">
                  How to Verify ChatGPT Plan
                </h2>
                <p className="mt-0.5 text-[12px] text-muted-foreground">Tutorial · YouTube</p>
              </div>
              {/* Inline YouTube embed */}
              <div className="relative mx-4 mb-4 mt-2 overflow-hidden rounded-xl" style={{ paddingBottom: "56.25%" }}>
                <iframe
                  src="https://www.youtube.com/embed/fk_nyjMDExQ?si=Wi6gh4xr5QQr1l7m"
                  title="How to Verify ChatGPT Plan"
